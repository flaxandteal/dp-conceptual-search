...
class Page(object):
    ...
    def get_corpus_sentences(self) -> List[str]:
        ...
        :return:
        """
        from supervised_models.python.utils import parse_sentences
        ...
        if self.has_description():
            ...
            if 'sections' in self._json:
                from supervised_models.python.corpa import markdown_to_text
    ...
    def get_labels(self) -> Set[str]:
        if self.has_keywords():
            from supervised_models.python.utils import parse
